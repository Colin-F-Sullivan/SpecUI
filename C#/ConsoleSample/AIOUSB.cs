...
namespace AIOUSBNet
{
    public class AIOUSB         // Prototype AIOUSB.dll data and functions in managed C# for .Net -- Watch for char arrays, UNICODE v ANSI, and strings
    {
        ...
        [DllImport("AIOUSB.DLL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 DIO_Configure(UInt32 DeviceIndex, Byte Tristate, ref Int16 OutMask, [In] Byte[] Data);
        [DllImport("AIOUSB.DLL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("AIOUSB.DLL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 DIO_ReadAll(UInt32 DeviceIndex, [Out] Byte[] Data);
        ...
        [DllImport("AIOUSB.DLL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 ADC_GetScanV(UInt32 DeviceIndex, [Out] Double[] pBuf);
        ...
        [DllImport("AIOUSB.DLL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 ADC_BulkContinuousEnd(UInt32 DeviceIndex, [Out] UInt32 pIOStatus);
        #endregion
        #endregion
        ...
        [DllImport("AIOUSB.DLL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 CTR_8254ReadStatus(UInt32 DeviceIndex, UInt32 BlockIndex, UInt32 CounterIndex, [Out] UInt16 ReadValue, [Out] Byte Status);
        [DllImport("AIOUSB.DLL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
